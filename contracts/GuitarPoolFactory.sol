...
// File: contracts/GuitarPoolFactory.sol

pragma solidity 0.6.12;

contract GuitarPoolFactory is Ownable {
    event NewGuitarPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(GuitarPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        GuitarPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewGuitarPoolContract(smartChefAddress);
    }
}
