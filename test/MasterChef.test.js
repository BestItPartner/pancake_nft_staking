...
contract('MasterChef', ([alice, bob, carol, dev, minter]) => {
    beforeEach(async () => {
        ...
        this.chef = await MasterChef.new(this.cake.address, this.syrup.address, dev, minter,'1000', '100', { from: minter });
    ...
    it('real case', async () => {
      ...
      await this.chef.add('2000', this.lp1.address,'100', true, { from: minter });
      ...
      await this.chef.add('500', this.lp3.address,'100', true, { from: minter });
      await this.chef.add('500', this.lp3.address,'100', true, { from: minter });
      await this.chef.add('100', this.lp3.address,'100', true, { from: minter });
      await this.chef.add('100', this.lp3.address,'100', true, { from: minter });
    ...
    it('deposit/withdraw', async () => {
      ...
      await this.chef.add('1000', this.lp2.address,'100', true, { from: minter });
      await this.chef.add('1000', this.lp3.address, '100',true, { from: minter });
